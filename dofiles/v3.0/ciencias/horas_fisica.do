*Horas1 totales fisica

use prueba.dta ,clear
preserve

keep if inlist(subsector1,35003)
...
*Horas1 idoneos totales fisica
preserve

keep if inlist(subsector1,35003)
collapse (sum) horas1 (first) subsector1 if ido_fisica1==1  , by(rbd)
...
*Horas2 totales fisica
preserve
keep if inlist(subsector2,35003)
...
*Horas2 idoneos totales fisica
preserve
keep if inlist(subsector2,35003)
collapse (sum) horas2 (first) subsector2 if ido_fisica2==1  , by(rbd)
