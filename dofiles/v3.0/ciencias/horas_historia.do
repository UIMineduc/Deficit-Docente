*Horas1 totales Historia

use prueba.dta ,clear

preserve

keep if inlist(subsector1,33001,33002)
...
*Horas1 idoneos totales Historia
preserve

keep if inlist(subsector1,33001,33002)
collapse (sum) horas1 if ido_hist1==1  , by(rbd)
...
*Horas2 totales Historia
preserve
keep if inlist(subsector2,33001,33002)
...
*Horas2 idoneos totales Historia
preserve
keep if inlist(subsector2,33001,33002)
collapse (sum) horas2 if ido_hist2==1  , by(rbd)
...
save base_historia.dta,replace
