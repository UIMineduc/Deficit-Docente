*Horas1 totales biologia

use prueba.dta ,clear

preserve

keep if inlist(subsector1,35001)
...
*Horas1 idoneos totales biologia
preserve

keep if inlist(subsector1,35001)
collapse (sum) horas1 (first) subsector1 if ido_biologia1==1  , by(rbd)
...
*Horas2 totales biologia
preserve
keep if inlist(subsector2,35001)
...
*Horas2 idoneos totales biologia
preserve
keep if inlist(subsector2,35001)
collapse (sum) horas2 (first) subsector2 if ido_biologia2==1  , by(rbd)
...
save base_biologia.dta,replace
