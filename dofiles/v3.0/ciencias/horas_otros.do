*Horas1 totales otros

use prueba.dta ,clear

preserve

keep if inlist(subsector1,35004)
...
*Horas1 idoneos totales otros
preserve

keep if inlist(subsector1,35004)
collapse (sum) horas1 (first) subsector1 if ido_cs1==1  , by(rbd)
...
*Horas2 totales otros
preserve
keep if inlist(subsector2,35004)
...
*Horas2 idoneos totales otros
preserve
keep if inlist(subsector2,35004)
collapse (sum) horas2 (first) subsector2 if ido_cs2==1  , by(rbd)
