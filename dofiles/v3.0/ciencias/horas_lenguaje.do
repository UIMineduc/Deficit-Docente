*Horas1 totales lenguaje

use prueba.dta ,clear

preserve

keep if inlist(subsector1,31001,31004)
...
keep if inlist(subsector1,31001,31004)
collapse (sum) horas1 if ido_leng1==1  , by(rbd)
...
preserve
keep if inlist(subsector2,31001,31004)
...
preserve
keep if inlist(subsector2,31001,31004)
collapse (sum) horas2 if ido_leng2==1  , by(rbd)
...
save base_lenguaje.dta,replace
