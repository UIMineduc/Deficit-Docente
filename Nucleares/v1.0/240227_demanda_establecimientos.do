...
**# 1 - Cantidad de cursos distintos por nivel (básica y media)
    ...
    *import delimited "$Matricula\20230906_Matrícula_unica_2023_20230430_WEB", varnames(1) encoding(UTF-8) clear
    *save "$Matricula\matricula_unica_2023.dta"
...
**# 2- Determinar la cantidad de horas teóricas de materias seleccionadas (matemáticas, lenguaje, ciencias, historia) necesarios por nivel para cada rbd utilizando el plan de estudios de 38 semanas.
...
global media "hist cs leng mate"
	...
	**# Demanda de horas
    ...
    save "$Data\dda_hrs_rbd_nivel_2023_38sem_v`i'.dta",replace
	}
